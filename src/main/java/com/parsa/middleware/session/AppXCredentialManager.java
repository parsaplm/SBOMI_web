...
public class AppXCredentialManager implements CredentialManager {
	...
	public String[] getCredentials(InvalidCredentialsException e) throws CanceledOperationException {
		...
		return promptForCredentials(null, null);
	}
	...
	public String[] getCredentials(InvalidUserException e) throws CanceledOperationException {
		...
		final String[] tokens = { name, password, group, role, discriminator };
		return tokens;
	}
	...
	public String[] promptForCredentials(String name, String password) throws CanceledOperationException {
		this.name = name;
		this.password = password;
		final String[] tokens = { this.name, this.password, group, role, discriminator };
		return tokens;
	}
