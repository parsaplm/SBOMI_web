...
/**
 * This implementation of the RequestListener, logs each service request to the
 * console.
 *
 */
public class AppXRequestListener implements RequestListener {
	...
	/**
	 * Called after each response from the server. Log the service operation to the
	 * console.
	 */
